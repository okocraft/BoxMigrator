package net.okocraft.boxmigrator;

import com.github.siroshun09.configapi.yaml.YamlConfiguration;
import net.okocraft.box.api.BoxProvider;
import net.okocraft.boxmigrator.database.Database;
import net.okocraft.boxmigrator.database.MySQLDatabase;
import net.okocraft.boxmigrator.database.SQLiteDatabase;
import net.okocraft.boxmigrator.table.ItemTable;
import net.okocraft.boxmigrator.table.MasterTable;
import net.okocraft.boxmigrator.table.PlayerTable;
...
public class BoxMigrator extends JavaPlugin {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (isSQLite != null && args[0].equalsIgnoreCase("confirm")) {
            ...
            CompletableFuture.runAsync(() -> {
                ...
                sender.sendMessage("Please stop the server and delete BoxMigrator-v4.jar.");
    ...
    private void sendCommonMessage(@NotNull CommandSender sender) {
        var name = isSQLite ? "SQLite (database.db)" : "MySQL";

        sender.sendMessage("Start the migration from " + name + ".");
        sender.sendMessage("The stock data to be migrated will be added to the existing stock data.");
        sender.sendMessage("The AutoStore settings will not be migrated, except for the settings for each item.");
    }
